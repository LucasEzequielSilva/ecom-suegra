...
const products = ({scrollRef}) => {
  ...
  return (
    <div className="w-full min-h-[100vh] flex flex-col justify-start items-center py-28" ref={scrollRef}>
        {/* row para sort */}
            ...
            <div className="flex p-4 gap-4 w-full min-h-[80vh]">
              ...
              <aside className="w-[20%] flex flex-col">
                <ul className='w-full flex flex-col gap-4' >
                  <li onClick={(e)=>handleSelectCategory(e.target.textContent)} className='text-[#566270] cursor-pointer hover:text-acento' role="listitem" aria-label="Este elemento seleccionable sirve para indicar que quieres buscar todos los productos" >Todos</li>
                  <li onClick={(e)=>handleSelectCategory(e.target.textContent)} className='text-[#566270] cursor-pointer hover:text-acento' role="listitem" aria-label="Este elemento seleccionable sirve para indicar que quieres buscar solo los productos de categoria 'aceites'" >Aceites</li>
                  <li onClick={(e)=>handleSelectCategory(e.target.textContent)} className='text-[#566270] cursor-pointer hover:text-acento' role="listitem" aria-label="Este elemento seleccionable sirve para indicar que quieres buscar solo los productos de categoria 'cremas'" >Cremas</li>
                  <li onClick={(e)=>handleSelectCategory(e.target.textContent)} className='text-[#566270] cursor-pointer hover:text-acento' role="listitem" aria-label="Este elemento seleccionable sirve para indicar que quieres buscar solo los productos de categoria 'chocolates'" >Chocolates</li>
                </ul>
              </aside>
              {/* products */}
